  ...
  return (
    <div className={cn("pointer-events-none relative h-full w-full", className)}>
      ...
      {error && showErrorPopup && (
        <div className="pointer-events-auto fixed top-4 right-4 z-50 max-w-sm transition-opacity duration-300">
      ...
      {error && !showErrorPopup && (
        <button
          ...
          className="pointer-events-auto fixed top-4 right-4 z-50 flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-black/60 text-white/50 shadow-lg backdrop-blur-xl transition-all hover:scale-105 hover:bg-black/80 hover:text-white/80"
