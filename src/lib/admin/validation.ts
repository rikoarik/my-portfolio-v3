...
export const sectionFormSchema = z.object({
  ...
  hero_brand: z.string().optional(),
  hero_cta_label: z.string().optional(),
  hero_cta_href: z.string().optional(),
  hero_title_size_mobile: z.string().optional(),
  hero_title_size_desktop: z.string().optional(),
  hero_role_size: z.string().optional(),
  hero_tagline_size: z.string().optional(),
  hero_cta_size: z.string().optional(),
